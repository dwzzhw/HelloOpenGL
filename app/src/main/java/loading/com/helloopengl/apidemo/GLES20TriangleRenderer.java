...
//                .openRawResource(R.raw.qq);
    ...
    private int loadShader(int shaderType, String source) {
        ...
        if (shader != 0) {
            ...
            if (compiled[0] == 0) {
                Loger.e(TAG, "Could not compile shader " + shaderType + ":");
                Loger.e(TAG, GLES20.glGetShaderInfoLog(shader));
    ...
    private int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (program != 0) {
            ...
            if (linkStatus[0] != GLES20.GL_TRUE) {
                Loger.e(TAG, "Could not link program: ");
                Loger.e(TAG, GLES20.glGetProgramInfoLog(program));
...
//            -1.0f, -0.5f, 0, 0.0f, 0.0f,
//            1.0f, -0.5f, 0, 1.0f, -0.0f,
//            0.0f, 1.11803399f, 0, 0.5f, 1.0f};
